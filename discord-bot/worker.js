// Cloudflare Worker - FPVGate Website GitHub Discord Notifications
// Receives GitHub webhook events and posts formatted embeds to Discord

const REPO_URL = 'https://github.com/LouisHitchcock/FPVGate-Website';
const AVATAR_URL = 'https://github.com/LouisHitchcock/FPVGate/raw/main/logo/logo.png';
const BOT_USERNAME = 'FPVGate Website GitHub';
...
function buildPushEmbed(data) {
  ...
  return {
    ...
    footer: { text: `${data.repository?.full_name || 'FPVGate-Website'}` },
